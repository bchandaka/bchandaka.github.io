...
img: assets/img/projects/mm_robot_real.jpg
importance: 1
category: research
---
...
<div class="row mt-4 justify-content-center">
    <div class="col-md-4">
        {% include figure.html path="assets/img/projects/mm_robot_real.jpg" title="Built robot" class="img-fluid rounded z-depth-1" caption="Real-world Robot" %}
    </div>
    <div class="col-md-8">
